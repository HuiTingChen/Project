...
public class FinanceS extends JFrame {  //2.1 GUI Finance
	 ...
	 * Create the frame.
	 */
	public FinanceS() {    //constructor with no argument
		super("FINANCE");
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					File file = new File("C:\\Users\\slche\\eclipse-workspace\\EducationBusinessProject\\src\\HomeTuition\\FINANCE-HOME TUITION CENTRE.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
