...
public class StudentRegistrationS extends JFrame {  //2.1 GUI StudentRegistration
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StudentRegistrationS frame = new StudentRegistrationS();
	 ...
	 * Create the frame.
	 */
	public StudentRegistrationS() {   //constructor with no argument
		...
		btnPrint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					File file = new File("C:\\Users\\slche\\eclipse-workspace\\EducationBusinessProject\\src\\HomeTuition\\STUDENT REGISTRATION-HOME TUITION CENTRE.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
