...
public class StaffsDetailsS extends JFrame {  //2.1 GUI StaffsDetails
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StaffsDetailsS frame = new StaffsDetailsS();
	 ...
	 * Create the frame.
	 */
	public StaffsDetailsS() {   //constructor with no argument
		super("STAFF DETAILS");
