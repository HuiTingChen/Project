...
public class StaffSalaryS extends JFrame {   //2.1 GUI StaffSalary
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StaffSalaryS frame = new StaffSalaryS();
	 ...
	 * Create the frame.
	 */
	public StaffSalaryS() {  //constructor with no argument
		...
		btnPrint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					File file = new File("C:\\Users\\slche\\eclipse-workspace\\EducationBusinessProject\\src\\HomeTuition\\STAFF SALARY DETAILS-HOME TUITION CENTRE.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
