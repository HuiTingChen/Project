...
public class SubjectsDescriptionS extends JFrame {   //2.1 GUI SubjectsDescription
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SubjectsDescriptionS frame = new SubjectsDescriptionS();
	 ...
	 * Create the frame.
	 */
	public SubjectsDescriptionS() {   //constructor with no argument
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				StudentRegistrationS sr = new StudentRegistrationS ();
				sr.setVisible(true);
				dispose();
			}
		});
